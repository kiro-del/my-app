    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: tokens.spacing[4] }}>
          ...
          <TextField label="Sales order number"   value={salesOrderNumber}  onChange={setSalesOrderNumber}  />
          <TextField label="Customer reference"   value={customerReference} onChange={setCustomerReference} />
          <TextField label="Cut rope batch number" value={batchNumber}      onChange={setBatchNumber}       />
